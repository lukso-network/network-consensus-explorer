...
func historicPoolPerformanceData() (*types.GenericChartData, error) {
	...
	chartData := &types.GenericChartData{
		...
		Subtitle:      "Uses a neutral & verifiable formula <a style=\"color:rgb(56, 112, 168)\" href=\"https://github.com/gobitfly/eth.store\">LYX.STORE</a> to measure pool performance for consensus & execution rewards.",
		XAxisTitle:    "",
