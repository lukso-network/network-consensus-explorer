...
// @Summary Get LYXE.STORE reference rate for a specified beaconchain-day or the latest day
// @Tags LYXE.STORE
// @Description LYXE.STORE represents the average financial return validators on the Ethereum network have achieved in a 24-hour period.
...
// @Produce json
// @Param day path string true "The beaconchain-day (periods of 225 epochs) to get the the LYXE.STORE for. Must be a number or the string 'latest'."
// @Success 200 {object} string
